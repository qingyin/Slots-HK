...
GCGIFT_FROMNAME_FIELD.number = 2
GCGIFT_FROMNAME_FIELD.index = 1
...
GCGIFT_PICTUREID_FIELD.number = 3
GCGIFT_PICTUREID_FIELD.index = 2
...
GCGIFT_FACEBOOKID_FIELD.number = 4
GCGIFT_FACEBOOKID_FIELD.index = 3
...
GCGIFT_TOPID_FIELD.number = 5
GCGIFT_TOPID_FIELD.index = 4
...
GCGIFT_GIFTID_FIELD.number = 6
GCGIFT_GIFTID_FIELD.index = 5
...
GCGIFT_STATE_FIELD.number = 7
GCGIFT_STATE_FIELD.index = 6
...
GCGIFT_TYPE_FIELD.number = 8
GCGIFT_TYPE_FIELD.index = 7
...
GCGIFT_ITEMID_FIELD.number = 9
GCGIFT_ITEMID_FIELD.index = 8
...
GCGIFT_ITEMCNT_FIELD.number = 10
GCGIFT_ITEMCNT_FIELD.index = 9
...
GCGIFT_TITLE_FIELD.number = 11
GCGIFT_TITLE_FIELD.index = 10
...
GCGIFT_CONTENT_FIELD.number = 12
GCGIFT_CONTENT_FIELD.index = 11
...
GCGIFT_GIFTPICTURE_FIELD.number = 13
GCGIFT_GIFTPICTURE_FIELD.index = 12
...
GCGIFT.nested_types = {}
GCGIFT.enum_types = {}
GCGIFT.fields = {GCGIFT_ID_FIELD, GCGIFT_FROMNAME_FIELD, GCGIFT_PICTUREID_FIELD, GCGIFT_FACEBOOKID_FIELD, GCGIFT_TOPID_FIELD, GCGIFT_GIFTID_FIELD, GCGIFT_STATE_FIELD, GCGIFT_TYPE_FIELD, GCGIFT_ITEMID_FIELD, GCGIFT_ITEMCNT_FIELD, GCGIFT_TITLE_FIELD, GCGIFT_CONTENT_FIELD, GCGIFT_GIFTPICTURE_FIELD}
