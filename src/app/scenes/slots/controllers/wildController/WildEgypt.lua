...
local WildEgypt = class("WildEgypt")
local wildMusic = 'slots/slots_egypt/audio/wild_show_egypt.mp3'

--------------------------------------
-- Construct
--------------------------------------
function WildEgypt:ctor( controller )
...
-- initWildSymbol
----------------------------------------------
function WildEgypt:initWildSymbol( holdArray )
...
-- playWild
----------------------------------------------
function WildEgypt:playWild( holdWildArray )
...
-- addHoldWild
-------------------------------------------
function WildEgypt:addHoldWild( matSy )
    ...
    if self.model:isFreeSpin() then
        ...
        local wildtext = display.newSprite("#wildtext.png")
...
-- dealHoldWild
--------------------------------------------
function WildEgypt:dealHoldWild( matHoldSy )
...
-- setHoldWildsToZero
---------------------------------------
function WildEgypt:setHoldWildsToZero()
...
-- setHoldSyToColLayer
------------------------------------------------
function WildEgypt:setHoldSyToColLayer( matSy )
...
-----------------------------------------------------
function WildEgypt:prepareInitWildArray( holdArray )
